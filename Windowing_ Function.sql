#Aggreagted windowing function -min,max,avg..
...
row_number() over(order by students_marks) as 'row_number' from ineuron_students where student_batch = 'fsda'

select student_id, student_batch ,student_stream, students_marks ,
row_number() over(partition by student_batch order by students_marks) as 'row_number' 
